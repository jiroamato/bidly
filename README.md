...
All content generated by the application are fictional.

We understand that there is more to the procurement process which includes processing of various documents, etc. Bidly is purely a **proof-of-concept** to showcase how agentic workflows can be integrated to the procurement process. In future iterations, we aim to build a fully-featured agentic system as other tasks can be extended out to agents, so long as they are provided with the appropriate tools.
